...
import static com.ms.dob.collage.MatrixUtils.calculateImageIndents;
import static com.ms.dob.collage.MatrixUtils.getMinMatrixScale;
import static com.ms.dob.collage.MatrixUtils.judgeIsImageContainsBorder;
...
public class CollagePiece {
  ...
  CollagePiece(Drawable drawable, Area area, Matrix matrix) {
