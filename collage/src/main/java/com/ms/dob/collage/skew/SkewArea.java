...
import static com.ms.dob.collage.skew.SkewUtils.distance;
import static com.ms.dob.collage.skew.SkewUtils.getPoint;
import static com.ms.dob.collage.skew.SkewUtils.intersectionOfLines;


class SkewArea implements Area {
  SkewLine lineLeft;
  SkewLine lineTop;
  SkewLine lineRight;
  SkewLine lineBottom;
  ...
  public boolean contains(float x, float y) {
    return SkewUtils.contains(this, x, y);
  }
  ...
  static class AreaComparator implements Comparator<SkewArea> {

    @Override
    public int compare(SkewArea one, SkewArea two) {
