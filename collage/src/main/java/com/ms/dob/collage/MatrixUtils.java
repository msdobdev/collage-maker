...
public class MatrixUtils {
  ...
  public static float getMinMatrixScale(CollagePiece piece) {
    if (piece != null) {
  ...
  static boolean judgeIsImageContainsBorder(CollagePiece piece, float rotateDegrees) {
    sTempMatrix.reset();
  ...
  static float[] calculateImageIndents(CollagePiece piece) {
  ...
  public static Matrix generateMatrix(CollagePiece piece, float extra) {
